...
def main():
    ...
    parser.add_argument("subject", nargs='?', help="subject of the note")
    parser.add_argument("title", nargs='?', help="title of the note")
    parser.add_argument("content", nargs='?', help="content of the note")
    parser.add_argument("-file", help="markdown file to copy content")
